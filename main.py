...
btn=Button(root,text="Speak",compound=LEFT,image=imageicon,height=100, width=180,font="arial 10 bold",command=speaknow)
btn.place(x=520,y=280)

imageicon2=PhotoImage(file="download.png")
save=Button(root,text="Save",compound=LEFT,image=imageicon2, width=160,bg="#39c790",font="arial 10 bold",command=download)
